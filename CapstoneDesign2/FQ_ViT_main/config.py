...
class Config:
    ...
    def __init__(self, ptf=True, lis=True, quant_method='minmax'):
        ...
        '''
        self.BIT_TYPE_7_W = BIT_TYPE_DICT['uint7']
        self.BIT_TYPE_7_A = BIT_TYPE_DICT['uint7']

        self.BIT_TYPE_6_W = BIT_TYPE_DICT['uint6']
        self.BIT_TYPE_6_A = BIT_TYPE_DICT['uint6']

        self.BIT_TYPE_5_W = BIT_TYPE_DICT['uint5']
        self.BIT_TYPE_5_A = BIT_TYPE_DICT['uint5']

        self.BIT_TYPE_4_W = BIT_TYPE_DICT['uint4']
        self.BIT_TYPE_4_A = BIT_TYPE_DICT['uint4']
