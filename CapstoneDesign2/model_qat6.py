...
class DownsampleBlock(nn.Module):
    def __init__(self, in_channels, out_channels, quant, calibrate):      
...
class UpsampleBlock(nn.Module):
    def __init__(self, in_channels, cat_channels, out_channels, quant, calibrate):
...
class DenoisingBlock(nn.Module):
    def __init__(self, in_channels, inner_channels, out_channels, quant, calibrate):
...
class RDUNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        # Encoder:
        # Level 0:
        self.input_block = InputBlock(channels, filters_0, quant, calibrate)
        self.block_0_0 = DenoisingBlock(filters_0, filters_0 // 2, filters_0, quant, calibrate)
        self.block_0_1 = DenoisingBlock(filters_0, filters_0 // 2, filters_0, quant, calibrate)
        self.down_0 = DownsampleBlock(filters_0, filters_1, quant, calibrate)

        # Level 1:
        self.block_1_0 = DenoisingBlock(filters_1, filters_1 // 2, filters_1, quant, calibrate)
        self.block_1_1 = DenoisingBlock(filters_1, filters_1 // 2, filters_1, quant, calibrate)
        self.down_1 = DownsampleBlock(filters_1, filters_2, quant, calibrate)

        # Level 2:
        self.block_2_0 = DenoisingBlock(filters_2, filters_2 // 2, filters_2, quant, calibrate)
        self.block_2_1 = DenoisingBlock(filters_2, filters_2 // 2, filters_2, quant, calibrate)
        self.down_2 = DownsampleBlock(filters_2, filters_3, quant, calibrate)

        # Level 3 (Bottleneck)
        self.block_3_0 = DenoisingBlock(filters_3, filters_3 // 2, filters_3, quant, calibrate)
        self.block_3_1 = DenoisingBlock(filters_3, filters_3 // 2, filters_3, quant, calibrate)

        # Decoder
        # Level 2:
        self.up_2 = UpsampleBlock(filters_3, filters_2, filters_2, quant, calibrate)
        self.block_2_2 = DenoisingBlock(filters_2, filters_2 // 2, filters_2, quant, calibrate)
        self.block_2_3 = DenoisingBlock(filters_2, filters_2 // 2, filters_2, quant, calibrate)

        # Level 1:
        self.up_1 = UpsampleBlock(filters_2, filters_1, filters_1, quant, calibrate)
        self.block_1_2 = DenoisingBlock(filters_1, filters_1 // 2, filters_1, quant, calibrate)
        self.block_1_3 = DenoisingBlock(filters_1, filters_1 // 2, filters_1, quant, calibrate)

        # Level 0:
        self.up_0 = UpsampleBlock(filters_1, filters_0, filters_0, quant, calibrate)
        self.block_0_2 = DenoisingBlock(filters_0, filters_0 // 2, filters_0, quant, calibrate)
        self.block_0_3 = DenoisingBlock(filters_0, filters_0 // 2, filters_0, quant, calibrate)

        self.output_block = OutputBlock(filters_0, channels, quant, calibrate)
